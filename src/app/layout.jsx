  ...
  <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <div className="flex justify-between h-16 items-center">
      ...
      <div className="flex items-center">
        <Link href="/" className="text-2xl font-black tracking-tighter text-indigo-600 dark:text-indigo-400 font-outfit">
          BLOG<span className="text-slate-900 dark:text-white">STREAM</span>
        </Link>
      </div>
      ...
      <div className="flex items-center space-x-4 sm:space-x-8">
        ...
        <div className="hidden sm:flex items-center space-x-8">
          <Link href="/" className="text-sm font-bold text-slate-600 dark:text-slate-400 hover:text-indigo-600 transition-colors">
            Articles
          </Link>
          <a href="#" className="text-sm font-bold text-slate-600 dark:text-slate-400 hover:text-indigo-600 transition-colors">
            Categories
          </a>
          <a href="#" className="text-sm font-bold text-slate-600 dark:text-slate-400 hover:text-indigo-600 transition-colors">
            About
        ...
        {/* Subscribe Button - Hidden on mobile, visible on SM up */}
        <div className="hidden sm:flex items-center space-x-4 border-l border-slate-200 dark:border-slate-800 pl-8">
